...
def captureTraffic():
    ...
    path_cauphumi   = ["loc03","vochicong-cauphumi","http://giaothong.hochiminhcity.gov.vn/render/ImageHandler.ashx?id=5a8269c45058170011f6eae4"]
...
def capture(path):
    ...
    while True:
        ...
        k = 'data/images/16-11/' + f'{path[0]}-{time.strftime("%Y_%m_%d_%H_%M_%S")}.jpg'
        print(k)
        with open(k, 'wb') as f:
